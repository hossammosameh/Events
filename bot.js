...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`welcome`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : 7amo ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`.bc | تبادل الفعاليات`,"http://twitch.tv/Death Shop")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/pF7XbnN
            **`);
